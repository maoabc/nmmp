...
public class MethodCall extends MethodCallBase {
        ...
        String[][] a27, String[] a28, String a29)
    {
        ...
        MyAssert.myassert(a0 == 0);
        MyAssert.myassert(a9 > 8.99 && a9 < 9.01);
        MyAssert.myassert(a16 == -16);
        MyAssert.myassert(a25 == 25);
        MyAssert.myassert(a29.equals("twenty nine"));
    }
