...
public class FloatMath {
    ...
    static void convTest() {
        ...
        f = 1238.5678f;
        d = (double) f;
        MyAssert.myassert(d > 1238.567 && d < 1238.568);
        ...
        d = 5678956789.0123;
        l = (long) d;
        MyAssert.myassert(l == 5678956789L);
        ...
        d = 1238.5678;
        f = (float) d;
        MyAssert.myassert(f > 1238.567 && f < 1238.568);
        ...
        i = 1234;
        f = (float) i;
        MyAssert.myassert(f > 1233.9f && f < 1234.1f);
        ...
        i = 1238;
        d = (double) i;
        MyAssert.myassert(d > 1237.9f && d < 1238.1f);
        ...
        l = 5678956789L;
        f = (float) l;
        MyAssert.myassert(f > 5.6789564E9 && f < 5.6789566E9);
        ...
        l = 6678956789L;
        d = (double) l;
        MyAssert.myassert(d > 6.6789567E9 && d < 6.6789568E9);

        l = -6678956789L;
        d = (double) l;
        MyAssert.myassert(d < -6.6789567E9 && d > -6.6789568E9);
    }
    public native static void convTestn();

    /*
     * We pass in the arguments and return the results so the compiler
     * doesn't do the math for us.
     */
    public static float[] floatOperTest(float x, float y) {
    ...
    static void floatOperCheck(float[] results) {
        MyAssert.myassert(results[0] > 69996.99f && results[0] < 69997.01f);
        MyAssert.myassert(results[1] > 70002.99f && results[1] < 70003.01f);
        MyAssert.myassert(results[2] > -210000.01f && results[2] < -209999.99f);
        MyAssert.myassert(results[3] > -23333.34f && results[3] < -23333.32f);
        MyAssert.myassert(results[4] > 0.999f && results[4] < 1.001f);
        MyAssert.myassert(results[8] > 70000.99f && results[8] < 70001.01f);
    }

    public native static float[] floatOperTestn(float x, float y);
    /*
     * We pass in the arguments and return the results so the compiler
     * doesn't do the math for us.
     */
    ...
    static void doubleOperCheck(double[] results) {
        MyAssert.myassert(results[0] > 69996.99 && results[0] < 69997.01);
        MyAssert.myassert(results[1] > 70002.99 && results[1] < 70003.01);
        MyAssert.myassert(results[2] > -210000.01 && results[2] < -209999.99);
        MyAssert.myassert(results[3] > -23333.34 && results[3] < -23333.32);
        MyAssert.myassert(results[4] > 0.999 && results[4] < 1.001);
        MyAssert.myassert(results[8] > 70000.99 && results[8] < 70001.01);
    }
    ...
    static void checkConvI(int[] results) {
        ...
        MyAssert.myassert(results[0] == 0x44332211);
        MyAssert.myassert(results[1] == 123);
        MyAssert.myassert(results[2] == -3);
        MyAssert.myassert(results[3] == 0x7fffffff);
        MyAssert.myassert(results[4] == 0x80000000);
        MyAssert.myassert(results[5] == 0);
    }
    ...
    static void checkConvL(long[] results) {
        ...
        MyAssert.myassert(results[0] == 0xFFFFFFFF88776655L);
        MyAssert.myassert(results[1] == 123);
        MyAssert.myassert(results[2] == -3);
        MyAssert.myassert(results[3] == 0x7fffffffffffffffL);
        MyAssert.myassert(results[4] == 0x8000000000000000L);
        MyAssert.myassert(results[5] == 0);
    }
    ...
    static void checkConsts() {
        ...
        MyAssert.myassert(f > 9.9 && f < 10.1);

        double d = 10.0;        // const-wide/special
        MyAssert.myassert(d > 9.9 && d < 10.1);
    }
    ...
    static boolean approxEqual2(double a, double b, double maxDelta) {
        if (a > b)
            return (a - b) < maxDelta;
        else
            return (b - a) < maxDelta;
    ...
    static void jlmTests(float ff, double dd) {
        ...
        MyAssert.myassert(approxEqual(Math.abs(ff), ff, 0.001f));
        MyAssert.myassert(approxEqual(Math.abs(-ff), ff, 0.001f));
        MyAssert.myassert(approxEqual(Math.min(ff, -5.0f), -5.0f, 0.001f));
        MyAssert.myassert(approxEqual(Math.max(ff, -5.0f), ff, 0.001f));

        MyAssert.myassert(approxEqual2(Math.abs(dd), dd, 0.001));
        MyAssert.myassert(approxEqual2(Math.abs(-dd), dd, 0.001));
        MyAssert.myassert(approxEqual2(Math.min(dd, -5.0), -5.0, 0.001));
        MyAssert.myassert(approxEqual2(Math.max(dd, -5.0), dd, 0.001));

        double sq = Math.sqrt(dd);
        MyAssert.myassert(approxEqual2(sq*sq, dd, 0.001));

        MyAssert.myassert(approxEqual2(0.5403023058681398, Math.cos(1.0), 0.00000001));
        MyAssert.myassert(approxEqual2(0.8414709848078965, Math.sin(1.0), 0.00000001));
    }
