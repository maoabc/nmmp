package tests.omnibus;// Copyright 2006 The Android Open Source Project
...
public class IntMath {
    ...
    static void shiftTest1() {
        ...
        MyAssert.myassert(i1 == 0x44332211);
        MyAssert.myassert(i2 == 0xbbaa9988);
        MyAssert.myassert(l == 0xbbaa998844332211L);
        l = (long) mBytes[0]
                | (long) mBytes[1] << 8
                | (long) mBytes[2] << 16
                | (long) mBytes[3] << 24
    ...
    static void shiftTest2() {
        ...
        MyAssert.myassert(result == 0x1122334455667788L);
    }
    ...
    static void unsignedShiftTest() {
        ...
        MyAssert.myassert((int) b == -1);
        MyAssert.myassert((int) s == -1);
        MyAssert.myassert((int) c == 0x0fff);
        MyAssert.myassert(i == 268435455);
    }
    ...
    static void convTest() {
        ...
        l = 5678956789L;
        i = (int) l;
        MyAssert.myassert(i == 1383989493);
    ...
    static void charSubTest() {
        ...
        i = char1 - char2;
        MyAssert.myassert(i == 0xffff00ea);
    }
    ...
    static void intOperCheck(int[] results) {
        ...
        MyAssert.myassert(result == minInt);

        MyAssert.myassert(results[0] == 69997);
        MyAssert.myassert(results[1] == 70003);
        MyAssert.myassert(results[2] == -210000);
        MyAssert.myassert(results[3] == 605032704);    // overflow / truncate
        MyAssert.myassert(results[4] == -23333);
        MyAssert.myassert(results[5] == 1);
        MyAssert.myassert(results[6] == 70000);
        MyAssert.myassert(results[7] == -3);
        MyAssert.myassert(results[8] == -70003);
        MyAssert.myassert(results[9] == 70000);
    }
    ...
    static void lit16Check(int[] results) {
        MyAssert.myassert(results[0] == 78777);
        MyAssert.myassert(results[1] == -76777);
        MyAssert.myassert(results[2] == 77777000);
        MyAssert.myassert(results[3] == 77);
        MyAssert.myassert(results[4] == 777);
        MyAssert.myassert(results[5] == 960);
        MyAssert.myassert(results[6] == -39);
        MyAssert.myassert(results[7] == -76855);
    }
    ...
    static void lit8Check(int[] results) {
        ...
        MyAssert.myassert(results[0] == -55545);
        MyAssert.myassert(results[1] == 55565);
        MyAssert.myassert(results[2] == -555550);
        MyAssert.myassert(results[3] == -5555);
        MyAssert.myassert(results[4] == -5);
        MyAssert.myassert(results[5] == 8);
        MyAssert.myassert(results[6] == -1);
        MyAssert.myassert(results[7] == 55563);
    }
    ...
    static void intShiftCheck(int[] results) {
        ...
        MyAssert.myassert(results[0] == 0x00aa0100);
        MyAssert.myassert(results[1] == 0xffff00aa);
        MyAssert.myassert(results[2] == 0x00ff00aa);
        MyAssert.myassert(results[3] == 0xaa00);
    }
    ...
    static void longOperCheck(long[] results) {
        ...
        MyAssert.myassert(result == minLong);

        MyAssert.myassert(results[0] == 69999999997L);
        MyAssert.myassert(results[1] == 70000000003L);
        MyAssert.myassert(results[2] == -210000000000L);
        MyAssert.myassert(results[3] == -6833923606740729856L);    // overflow
        MyAssert.myassert(results[4] == -23333333333L);
        MyAssert.myassert(results[5] == 1);
        MyAssert.myassert(results[6] == 70000000000L);
        MyAssert.myassert(results[7] == -3);
        MyAssert.myassert(results[8] == -70000000003L);
        MyAssert.myassert(results[9] == 70000000000L);

        MyAssert.myassert(results.length == 10);
    }
    ...
    static long longShiftCheck(long[] results) {
        ...
        MyAssert.myassert(results[0] == 0x96deff00aa010000L);
        MyAssert.myassert(results[1] == 0xffffd5aa96deff00L);
        MyAssert.myassert(results[2] == 0x0000d5aa96deff00L);
        MyAssert.myassert(results[3] == 0xffff96deff000000L);

        MyAssert.myassert(results.length == 4);
    ...
    static void truncateCheck(Shorty shorts) {
        MyAssert.myassert(shorts.mShort == -5597);     // 0xea23
        MyAssert.myassert(shorts.mChar == 59939);      // 0xea23
        MyAssert.myassert(shorts.mByte == 35);         // 0x23
    }
    ...
    static void bigDivideOverflow(int idiv, long ldiv) {
        ...
        MyAssert.myassert(intDivResult == mostNegInt);
        MyAssert.myassert(intModResult == 0);
        MyAssert.myassert(longDivResult == mostNegLong);
        MyAssert.myassert(longModResult == 0);
    }
    ...
    static void checkConsts(byte small, short medium, int large, long huge) {
        ...
        MyAssert.myassert(small == 1);                     // const/4
        MyAssert.myassert(medium == -256);                 // const/16
        MyAssert.myassert(medium == -256L);                // const-wide/16
        MyAssert.myassert(large == -88888);                // const
        MyAssert.myassert(large == -88888L);               // const-wide/32
        MyAssert.myassert(huge == 0x9922334455667788L);    // const-wide
    }
...
//
        MyAssert.myassert(Math.abs(ii) == ii);
        MyAssert.myassert(Math.abs(-ii) == ii);
        MyAssert.myassert(Math.min(ii, -5) == -5);
        MyAssert.myassert(Math.max(ii, -5) == ii);

        MyAssert.myassert(Math.abs(ll) == ll);
        MyAssert.myassert(Math.abs(-ll) == ll);
        MyAssert.myassert(Math.min(ll, -5L) == -5L);
        MyAssert.myassert(Math.max(ll, -5L) == ll);
    }
    ...
    public static void run() {
        ...
        MyAssert.myassert(longRet == 0x96deff00aa010000L);
